---
name: verificar-runbook
description: Valida este repositório de ponta a ponta antes de um commit — sintaxe dos scripts, links de Markdown, caminhos citados, pacotes que existem no apt e o status do gerenciador. Use depois de mover pasta, renomear guia, editar script ou mudar lista de pacotes; não use para aplicar tema, que é trabalho do kali-look.sh.
---
