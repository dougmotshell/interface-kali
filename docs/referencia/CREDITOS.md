...
| `painel/Kali.tar.bz2`, `painel/Kali compact.tar.bz2`, `painel/xfce4-panel-genmon-vpnip.sh`, `kde/KaliDark.colors`, `kde/Kali-Dark.{profile,colorscheme}`, `kde/kali-panel-customizations.js`, `shell/tilix-Kali.json` | `kali-themes-common` | 2026.3.0 |
